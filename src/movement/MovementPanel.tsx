...
import { formatCoordinate, formatDistance } from "../lib/geo";
import { TravelTimer } from "../cooldown/TravelTimer";
import "./MovementPanel.css";

export function MovementPanel() {
  const [mode, setMode] = useState<SpeedMode>("walking");
  const [activeDirection, setActiveDirection] = useState<CompassDirection | null>(null);
  ...
  const handleManualSet = () => {
    ...
    void setTestLocation({ latitude: lat, longitude: lon }, "manual-entry");
  };
